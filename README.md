# pizzeria-Manage
This is a project implemented with Spring boot and JPA data. It is a REST application for a pizzeria, which receives the orders, lists the pizzas and contains customer information.

Generate this stored procedure: 
```sql
